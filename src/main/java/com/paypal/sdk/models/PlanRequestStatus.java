...
public enum PlanRequestStatus {
     ...
     */
    @JsonCreator
    public static PlanRequestStatus constructFromString(String toConvert) throws IOException {
        PlanRequestStatus enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static PlanRequestStatus fromString(String toConvert) {
     ...
     * @param toConvert The list of PlanRequestStatus values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<PlanRequestStatus> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (PlanRequestStatus enumValue : toConvert) {
