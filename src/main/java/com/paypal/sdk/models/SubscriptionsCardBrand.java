...
/**
 * SubscriptionsCardBrand to be used.
 */
public enum SubscriptionsCardBrand {
    ...
    private static TreeMap<String, SubscriptionsCardBrand> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static SubscriptionsCardBrand constructFromString(String toConvert) throws IOException {
        SubscriptionsCardBrand enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static SubscriptionsCardBrand fromString(String toConvert) {
     ...
     * @param toConvert The list of SubscriptionsCardBrand values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<SubscriptionsCardBrand> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (SubscriptionsCardBrand enumValue : toConvert) {
