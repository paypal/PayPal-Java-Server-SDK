...
public class SubscriptionApplicationContext {
     ...
     * @param  userAction  ApplicationContextUserAction value for userAction.
     ...
     * experience.
     * @return Returns the ApplicationContextUserAction
     */
    @JsonGetter("user_action")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ApplicationContextUserAction getUserAction() {
        return userAction;
    }
     ...
     * Configures the label name to `Continue` or `Subscribe Now` for subscription consent
     * experience.
     * @param userAction Value for ApplicationContextUserAction
     */
    ...
    public String toString() {
        return "SubscriptionApplicationContext [" + "returnUrl=" + returnUrl + ", cancelUrl="
    ...
    /**
     * Builds a new {@link SubscriptionApplicationContext.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SubscriptionApplicationContext.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SubscriptionApplicationContext}.
     */
    public static class Builder {
        ...
        private ApplicationContextUserAction userAction =
                ApplicationContextUserAction.SUBSCRIBE_NOW;
        private PaymentMethod paymentMethod;
         ...
         * @return Builder
         */
        public Builder userAction(ApplicationContextUserAction userAction) {
            this.userAction = userAction;
            return this;
        }
        ...
        /**
         * Builds a new {@link SubscriptionApplicationContext} object using the set fields.
         * @return {@link SubscriptionApplicationContext}
         */
        public SubscriptionApplicationContext build() {
            return new SubscriptionApplicationContext(returnUrl, cancelUrl, brandName, locale,
                    shippingPreference, userAction, paymentMethod);
        }
    }
}
