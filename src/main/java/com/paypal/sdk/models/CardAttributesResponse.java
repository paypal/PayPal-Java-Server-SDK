...
public class CardAttributesResponse {
    private CardVaultResponse vault;
     ...
     * @param  vault  CardVaultResponse value for vault.
     */
    public CardAttributesResponse(
            CardVaultResponse vault) {
        this.vault = vault;
    }
     ...
     * @return Returns the CardVaultResponse
     */
    @JsonGetter("vault")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public CardVaultResponse getVault() {
        return vault;
    }
     ...
     * Setter for Vault.
     * The details about a saved Card payment source.
     * @param vault Value for CardVaultResponse
     */
    @JsonSetter("vault")
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder vault(CardVaultResponse vault) {
            this.vault = vault;
            return this;
        }
