...
public enum UsageType {
     ...
     */
    @JsonCreator
    public static UsageType constructFromString(String toConvert) throws IOException {
        UsageType enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static UsageType fromString(String toConvert) {
     ...
     * @param toConvert The list of UsageType values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<UsageType> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (UsageType enumValue : toConvert) {
