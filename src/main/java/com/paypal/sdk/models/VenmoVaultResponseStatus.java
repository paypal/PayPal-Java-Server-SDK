...
/**
 * VenmoVaultResponseStatus to be used.
 */
public enum VenmoVaultResponseStatus {
     ...
     */
    @JsonCreator
    public static VenmoVaultResponseStatus constructFromString(String toConvert) throws IOException {
        VenmoVaultResponseStatus enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static VenmoVaultResponseStatus fromString(String toConvert) {
    ...
    /**
     * Convert list of VenmoVaultResponseStatus values to list of string values.
     * @param toConvert The list of VenmoVaultResponseStatus values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<VenmoVaultResponseStatus> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (VenmoVaultResponseStatus enumValue : toConvert) {
