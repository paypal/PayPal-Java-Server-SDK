...
/**
 * This is a model class for SubscriptionCardRequest type.
 */
public class SubscriptionCardRequest {
    ...
    private SubscriptionsCardBrand brand;
    private Address billingAddress;
    private SubscriptionsCardAttributes attributes;
     ...
     * @param  brand  SubscriptionsCardBrand value for brand.
     * @param  billingAddress  Address value for billingAddress.
     * @param  attributes  SubscriptionsCardAttributes value for attributes.
     */
    public SubscriptionCardRequest(
            String name,
            String number,
     ...
     * @return Returns the SubscriptionsCardBrand
     */
    @JsonGetter("brand")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public SubscriptionsCardBrand getBrand() {
        return brand;
    }
     ...
     * Setter for Brand.
     * The card network or brand. Applies to credit, debit, gift, and payment cards.
     * @param brand Value for SubscriptionsCardBrand
     */
    @JsonSetter("brand")
     ...
     * @return Returns the SubscriptionsCardAttributes
     */
     ...
     * Additional attributes associated with the use of this card.
     * @param attributes Value for SubscriptionsCardAttributes
     */
    ...
    public String toString() {
        return "SubscriptionCardRequest [" + "name=" + name + ", number=" + number + ", expiry="
                + expiry + ", securityCode=" + securityCode + ", type=" + type + ", brand=" + brand
                + ", billingAddress=" + billingAddress + ", attributes=" + attributes + "]";
    }

    /**
     * Builds a new {@link SubscriptionCardRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SubscriptionCardRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SubscriptionCardRequest}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder brand(SubscriptionsCardBrand brand) {
            this.brand = brand;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder attributes(SubscriptionsCardAttributes attributes) {
            this.attributes = attributes;
            return this;
        }

        /**
         * Builds a new {@link SubscriptionCardRequest} object using the set fields.
         * @return {@link SubscriptionCardRequest}
         */
        public SubscriptionCardRequest build() {
            return new SubscriptionCardRequest(name, number, expiry, securityCode, type, brand,
