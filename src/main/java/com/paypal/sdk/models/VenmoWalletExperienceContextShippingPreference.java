...
/**
 * VenmoWalletExperienceContextShippingPreference to be used.
 */
public enum VenmoWalletExperienceContextShippingPreference {
    ...
    private static TreeMap<String, VenmoWalletExperienceContextShippingPreference> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static VenmoWalletExperienceContextShippingPreference constructFromString(String toConvert) throws IOException {
        VenmoWalletExperienceContextShippingPreference enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static VenmoWalletExperienceContextShippingPreference fromString(String toConvert) {
     ...
     * @param toConvert The list of VenmoWalletExperienceContextShippingPreference values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<VenmoWalletExperienceContextShippingPreference> toConvert) {
        if (toConvert == null) {
            return null;
        }
