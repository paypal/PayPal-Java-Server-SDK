...
/**
 * This is a model class for ItemRequest type.
 */
public class ItemRequest {
     ...
     * spaces) will be truncated. The 2048 character limit is reflected in the response
    ...
    /**
     * Converts this ItemRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ItemRequest [" + "name=" + name + ", unitAmount=" + unitAmount + ", quantity="
                + quantity + ", tax=" + tax + ", description=" + description + ", sku=" + sku
                + ", url=" + url + ", category=" + category + ", imageUrl=" + imageUrl + ", upc="
                + upc + ", billingPlan=" + billingPlan + "]";
    }

    /**
     * Builds a new {@link ItemRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ItemRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ItemRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ItemRequest} object using the set fields.
         * @return {@link ItemRequest}
         */
        public ItemRequest build() {
            return new ItemRequest(name, unitAmount, quantity, tax, description, sku, url, category,
