...
/**
 * PaypalWalletContextShippingPreference to be used.
 */
public enum PaypalWalletContextShippingPreference {
     ...
     */
    @JsonCreator
    public static PaypalWalletContextShippingPreference constructFromString(String toConvert) throws IOException {
        PaypalWalletContextShippingPreference enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static PaypalWalletContextShippingPreference fromString(String toConvert) {
     ...
     * @param toConvert The list of PaypalWalletContextShippingPreference values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<PaypalWalletContextShippingPreference> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (PaypalWalletContextShippingPreference enumValue : toConvert) {
