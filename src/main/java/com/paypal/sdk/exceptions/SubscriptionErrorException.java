 ...
 */
public class SubscriptionErrorException extends ApiException {
    private static final long serialVersionUID = -3553823881580351752L;
    private String name;
     ...
     */
    public SubscriptionErrorException(String reason, Context context) {
    ...
    /**
     * Converts this SubscriptionErrorException into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SubscriptionErrorException [" + "statusCode=" + getResponseCode() + ", message="
