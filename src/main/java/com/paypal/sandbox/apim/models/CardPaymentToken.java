...
import com.paypal.sandbox.apim.utilities.JsonValue;
...
public class CardPaymentToken {
    ...
    private JsonValue networkToken;
     ...
     * @param  networkToken  JsonValue value for networkToken.
     */
    public CardPaymentToken(
            String name,
            String lastDigits,
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public JsonValue getNetworkToken() {
        return networkToken;
    }

    /**
     * Setter for NetworkToken.
     * @param networkToken Value for JsonValue
     */
    @JsonSetter("network_token")
    public void setNetworkToken(JsonValue networkToken) {
        this.networkToken = networkToken;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder networkToken(JsonValue networkToken) {
            this.networkToken = networkToken;
            return this;
        }
