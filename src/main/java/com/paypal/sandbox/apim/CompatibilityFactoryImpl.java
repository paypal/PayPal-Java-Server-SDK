...
import com.paypal.sandbox.apim.http.Headers;
import com.paypal.sandbox.apim.http.client.HttpContext;
import com.paypal.sandbox.apim.http.request.HttpBodyRequest;
import com.paypal.sandbox.apim.http.request.HttpMethod;
import com.paypal.sandbox.apim.http.request.HttpRequest;
import com.paypal.sandbox.apim.http.response.ApiResponse;
import com.paypal.sandbox.apim.http.response.HttpResponse;
import com.paypal.sandbox.apim.http.response.HttpStringResponse;
