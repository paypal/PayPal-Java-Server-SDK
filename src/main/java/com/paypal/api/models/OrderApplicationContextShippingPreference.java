...
public enum OrderApplicationContextShippingPreference {
     ...
     */
    @JsonCreator
    public static OrderApplicationContextShippingPreference constructFromString(String toConvert) throws IOException {
        OrderApplicationContextShippingPreference enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static OrderApplicationContextShippingPreference fromString(String toConvert) {
     ...
     * @param toConvert The list of OrderApplicationContextShippingPreference values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<OrderApplicationContextShippingPreference> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (OrderApplicationContextShippingPreference enumValue : toConvert) {
