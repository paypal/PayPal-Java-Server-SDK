...
import com.paypal.sdk.models.SubscriptionCustomerInformation;

SubscriptionCustomerInformation subscriptionCustomerInformation = new SubscriptionCustomerInformation.Builder()
    .id("id6")
