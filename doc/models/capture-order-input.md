...
Input structure for the method CaptureOrderAsync
...
|  --- | --- | --- | --- | --- | --- |
| `Id` | `String` | Required | The ID of the order for which to capture a payment.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `36`, *Pattern*: `^[A-Z0-9]+$` | String getId() | setId(String id) |
...
| `Body` | [`OrderCaptureRequest`](../../doc/models/order-capture-request.md) | Optional | - | OrderCaptureRequest getBody() | setBody(OrderCaptureRequest body) |
