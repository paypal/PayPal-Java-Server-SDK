...
| `Card` | `JsonValue` | Optional | The payment card information. | JsonValue getCard() | setCard(JsonValue card) |
...
| `AssuranceDetails` | `JsonValue` | Optional | - | JsonValue getAssuranceDetails() | setAssuranceDetails(JsonValue assuranceDetails) |
