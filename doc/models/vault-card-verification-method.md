...
```java
import com.paypal.sdk.models.VaultCardVerificationMethod;

VaultCardVerificationMethod vaultCardVerificationMethod = VaultCardVerificationMethod.SCA_WHEN_REQUIRED;
```
