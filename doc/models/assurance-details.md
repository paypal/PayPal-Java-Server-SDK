...
|  --- | --- | --- | --- | --- | --- |
| `AccountVerified` | `Boolean` | Optional | If true, indicates that Cardholder possession validation has been performed on returned payment credential.<br><br>**Default**: `false` | Boolean getAccountVerified() | setAccountVerified(Boolean accountVerified) |
...
```java
import com.paypal.sdk.models.AssuranceDetails;

AssuranceDetails assuranceDetails = new AssuranceDetails.Builder()
