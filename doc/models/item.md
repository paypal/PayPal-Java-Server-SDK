...
| `Description` | `String` | Optional | The detailed item description.<br><br>**Constraints**: *Maximum Length*: `2048` | String getDescription() | setDescription(String description) |
