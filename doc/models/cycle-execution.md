...
|  --- | --- | --- | --- | --- | --- |
| `TenureType` | [`TenureType`](../../doc/models/tenure-type.md) | Required, Read-only | The type of the billing cycle.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `24`, *Pattern*: `^[A-Z_]+$` | TenureType getTenureType() | setTenureType(TenureType tenureType) |
...
| `CyclesCompleted` | `int` | Required, Read-only | The number of billing cycles that have completed.<br><br>**Constraints**: `>= 0`, `<= 9999` | int getCyclesCompleted() | setCyclesCompleted(int cyclesCompleted) |
| `CyclesRemaining` | `Integer` | Optional, Read-only | For a finite billing cycle, cycles_remaining is the number of remaining cycles. For an infinite billing cycle, cycles_remaining is set as 0.<br><br>**Constraints**: `>= 0`, `<= 9999` | Integer getCyclesRemaining() | setCyclesRemaining(Integer cyclesRemaining) |
