...
| `Links` | `List<JsonValue>` | Optional | DEPRECATED. This field is DEPRECATED.<br><br>**Constraints**: *Maximum Items*: `16` | List<JsonValue> getLinks() | setLinks(List<JsonValue> links) |
