...
|  --- | --- | --- | --- | --- | --- |
| `Id` | `String` | Optional, Read-only | The tracker id. | String getId() | setId(String id) |
...
| `Links` | [`List<LinkDescription>`](../../doc/models/link-description.md) | Optional, Read-only | An array of request-related HATEOAS links. | List<LinkDescription> getLinks() | setLinks(List<LinkDescription> links) |
...
OrderTrackerResponse orderTrackerResponse = new OrderTrackerResponse.Builder()
