...
import com.paypal.sdk.models.NetworkTransactionReferenceEntity;

NetworkTransactionReferenceEntity networkTransactionReferenceEntity = new NetworkTransactionReferenceEntity.Builder(
    "id4"
)
.date("date0")
