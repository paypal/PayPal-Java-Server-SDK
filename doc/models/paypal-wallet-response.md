...
| `AccountStatus` | [`PaypalWalletAccountVerificationStatus`](../../doc/models/paypal-wallet-account-verification-status.md) | Optional, Read-only | The account status indicates whether the buyer has verified the financial details associated with their PayPal account.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `255`, *Pattern*: `^[A-Z_]+$` | PaypalWalletAccountVerificationStatus getAccountStatus() | setAccountStatus(PaypalWalletAccountVerificationStatus accountStatus) |
