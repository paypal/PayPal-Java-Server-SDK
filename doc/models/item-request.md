...
| `Description` | `String` | Optional | This field supports up to 4000 characters, but any content beyond 2048 characters (including spaces) will be truncated. The 2048 character limit is reflected in the response representation of this field.<br><br>**Constraints**: *Maximum Length*: `4000` | String getDescription() | setDescription(String description) |
...
ItemRequest itemRequest = new ItemRequest.Builder(
    "name8",
    new Money.Builder(
        "currency_code2",
        "value8"
