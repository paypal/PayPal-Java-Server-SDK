...
|  --- | --- | --- | --- | --- | --- |
| `Id` | `String` | Optional | The unique PayPal-generated ID for the plan.<br><br>**Constraints**: *Minimum Length*: `26`, *Maximum Length*: `26`, *Pattern*: `^P-[A-Z0-9]*$` | String getId() | setId(String id) |
