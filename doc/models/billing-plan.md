...
|  --- | --- | --- | --- | --- | --- |
| `Id` | `String` | Optional, Read-only | The unique PayPal-generated ID for the plan.<br><br>**Constraints**: *Minimum Length*: `26`, *Maximum Length*: `26`, *Pattern*: `^P-[A-Z0-9]*$` | String getId() | setId(String id) |
...
| `Status` | [`SubscriptionPlanStatus`](../../doc/models/subscription-plan-status.md) | Optional | The plan status.<br><br>**Constraints**: *Minimum Length*: `1`, *Maximum Length*: `24`, *Pattern*: `^[A-Z_]+$` | SubscriptionPlanStatus getStatus() | setStatus(SubscriptionPlanStatus status) |
...
BillingPlan billingPlan = new BillingPlan.Builder()
