...
| `ExperienceContext` | [`VenmoExperienceContext`](../../doc/models/venmo-experience-context.md) | Optional | A resource representing an experience context of vault a venmo account. | VenmoExperienceContext getExperienceContext() | setExperienceContext(VenmoExperienceContext experienceContext) |
...
VaultVenmoRequest vaultVenmoRequest = new VaultVenmoRequest.Builder()
