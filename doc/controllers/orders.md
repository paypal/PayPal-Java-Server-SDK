...
```java
CompletableFuture<ApiResponse<Order>> ordersCreateAsync(
...
```java
CompletableFuture<ApiResponse<Void>> ordersPatchAsync(
...
```java
CompletableFuture<ApiResponse<Order>> ordersCaptureAsync(
...
```java
CompletableFuture<ApiResponse<Void>> ordersTrackersPatchAsync(
